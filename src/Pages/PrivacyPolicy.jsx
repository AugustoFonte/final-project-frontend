  ...
  return (
    <MainLayout>
      <div className="content-center">
        <h1 className="font-bold text-4xl flex justify-center py-5 px-5 text-sky-900">Privacy Policy for Stand Carrocinha</h1>
        <p className="p-20 text-lg items-center">At Stand Carrochinha, accessible at
        standcarrochinha.com, one of our main priorities is the privacy of our visitors.
